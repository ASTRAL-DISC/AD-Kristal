...
function CreditsText:draw()
	...
	elseif self.music:tell() > 11.3 and self.music:tell() < 14.17 then
		...
		Draw.setColor(1, 1, 1)
		love.graphics.printf("WILTZY", 0, 60, SCREEN_WIDTH, "center")
	...
	elseif self.music:tell() > 17.0 and self.music:tell() < 19.8 then
		...
		Draw.setColor(1, 1, 1)
		love.graphics.printf("WILTZY", -100, 60, SCREEN_WIDTH, "center")
	...
	elseif self.music:tell() > 31.1 and self.music:tell() < 33.95 then
		...
		love.graphics.printf("SamDeluxe", 100, 100, SCREEN_WIDTH, "center")
		love.graphics.printf("Skarph", 100, 140, SCREEN_WIDTH, "center")
	elseif self.music:tell() > 33.95 and self.music:tell() < 36.7 then
		love.graphics.printf("-Libraries & Resources-", 0, 20, SCREEN_WIDTH, "center")
		Draw.setColor(1, 1, 1)
		love.graphics.printf("J.A.R.U.", -100, 60, SCREEN_WIDTH, "center")
		love.graphics.printf("Hyperboid", -100, 100, SCREEN_WIDTH, "center")
		love.graphics.printf("Agent 7", -100, 140, SCREEN_WIDTH, "center")
		love.graphics.printf("AcousticJamm", 100, 60, SCREEN_WIDTH, "center")
		love.graphics.printf("FireRainV", 100, 100, SCREEN_WIDTH, "center")
		love.graphics.printf("crocokuo", 100, 140, SCREEN_WIDTH, "center")
	elseif self.music:tell() > 36.7 and self.music:tell() < 39.5 then
		love.graphics.printf("-Libraries & Resources-", 0, 20, SCREEN_WIDTH, "center")
		Draw.setColor(1, 1, 1)
		love.graphics.printf("Mr. Oinky", -100, 60, SCREEN_WIDTH, "center")
		love.graphics.printf("Simbel", -100, 100, SCREEN_WIDTH, "center")
		love.graphics.printf("KateBulka", -100, 140, SCREEN_WIDTH, "center")
		love.graphics.printf("Bor", 100, 60, SCREEN_WIDTH, "center")
		love.graphics.printf("Trashcat", 100, 100, SCREEN_WIDTH, "center")
		love.graphics.printf("Freesound", 100, 140, SCREEN_WIDTH, "center")
