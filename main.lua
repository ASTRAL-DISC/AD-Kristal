...
BluePlatform = require("src.engine.game.battle.souls.blueplatform")
CyanSoul = require("src.engine.game.battle.souls.cyansoul")
CyanWave = require("src.engine.game.battle.souls.cyanwave")
GreenSoul = require("src.engine.game.battle.souls.greensoul")
GreenSoulBullet = require("src.engine.game.battle.souls.greensoulbullet")
GreenSoulCircle = require("src.engine.game.battle.souls.greensoulcircle")
GreenSoulShield = require("src.engine.game.battle.souls.greensoulshield")
PurpleSoul = require("src.engine.game.battle.souls.purplesoul")
PurpleWave = require("src.engine.game.battle.souls.purplewave")
