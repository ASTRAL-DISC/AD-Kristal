...
function DialogueText:init(text, x, y, w, h, options)
    ...
    options["style"] = options["style"] or Kristal.callEvent(KRISTAL_EVENT.getDialogueTextStyle, text, options) or (Game:isLight() and "none") or (Game:isPast() and "none") or (Game:isDepths() and "depths") or "dark"
