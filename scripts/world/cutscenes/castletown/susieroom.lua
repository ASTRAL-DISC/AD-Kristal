return {
    bed = function(cutscene, event, chara, facing)
    ...
    fridge = function(cutscene, event, chara, facing)
    ...
    manual_stand = function(cutscene, event, chara, facing)
    ...
    clothes_drawer = function(cutscene, event, chara, facing)
