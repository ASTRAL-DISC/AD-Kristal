local Saxophone, super = Class(Wave, "saxophone")

function Saxophone:init()
    super.init(self)
...
local function spawnNote(self, wave, enemy)
	...
	local bullet = self:spawnBullet("ch3/shadowguy/note", x, y)
	bullet.curve = wave.curve
end

local function generateWave(self, enemy)
	Assets.playSound("saxophone", 2)
